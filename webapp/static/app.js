  ...
  const premiumBlock = !ME.is_premium ? `
    ...
    ` : (() => {
      ...
      return `
        ...
        <div class="onboard">
          <p>Спроси о чём угодно — отвечу лично по твоим числам и текущему периоду.
          Любовь, деньги, работа, важное решение. Я помню, о чём мы говорили, —
          пиши как близкой подруге. Например: «что с деньгами в марте?» или
          «стоит ли сейчас менять работу?»</p>
